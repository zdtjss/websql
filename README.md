...
3. 自动提示表明及字段名
4. 支持基于操作系统的人脸/指纹识别登录
5. 支持自动备份delete、update操作的数据以备sql审计
6. 支持excel导入导出、insert/update/create脚本导出
7. 暂时仅支持MySQL、Oracle、sqlite数据库
8. 严格的链接级权限管控

### 开源协议宽松，可以自由使用，以满足个人或企业需求。

  
  指纹/人脸识别仅在用户操作系统及硬件支持且https下证书有效可信或http下使用localhost访问时才可用。
