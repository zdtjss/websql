<template>
    <el-container>
        <el-header height="30px" class="toolbar">
            <el-button @click="exec" :loading="exectingSql" title="Ctrl + Enter">执行</el-button>
        ...
        <el-main id="sqlArea" class="sql_area" :style="{ height: sqlDivHeight }" @keyup.ctrl.enter="exec"
